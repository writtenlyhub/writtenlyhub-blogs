...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const res = await fetch('https://www.writtenlyhub.com/wp-admin/admin-ajax.php', {
      method: 'POST',
      body: formData
    });
  ...
  return (
    <div className="mt-16 bg-white border p-6 rounded-lg shadow-md max-w-2xl mx-auto">
      <h3 className="text-xl font-bold text-orange-500 mb-2">Subscribe to Our Newsletter</h3>
      <p className="text-gray-700 mb-4 text-sm">
        Get the latest blogs, tips, and writing resources delivered straight to your inbox.
      </p>
