              ...
              <article className="w-full lg:w-8/12">                      
                ...
                {post.excerpt?.rendered && (
                  <div className="mb-6 p-4 bg-orange-50 border-l-4 border-orange-400 rounded">
                    <h2 className="text-lg font-semibold mb-2 text-orange-800">TL;DR</h2>
                    <div
                ...
                {featuredImage && (
                  <div className="mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-3 px-4 bg-gray-50 rounded-lg gap-2">
